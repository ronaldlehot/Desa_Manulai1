...
<div class="row">
		<div class="col-md-6">
			<h3>Selamat Datang <b>Admin Desa Manulai 1</b></h3>
			<legend></legend>
		</div>
		<div class="col-md-6" >
		...
		<div class="col-md-12">
			<a href="<?php echo site_url('admin/c_dusun/');?>">
				<button type="button" class="btn btn-warning"><i class="fa fa-eye fa-fw"></i> Lihat Data Dusun</button>
			</a>
			<a href="<?php echo site_url('admin/c_ped_pertanian/');?>">
				<button type="button" class="btn btn-warning"><i class="fa fa-eye fa-fw"></i> Lihat Data Pertanian</button>
			</a>		
		</div>
	</div>
	<br>
