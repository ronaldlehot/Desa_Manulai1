...
<?php echo form_open_multipart('admin/c_demografi/update_demografi'); ?>

	<input type="hidden" name="id_pengguna" id="id_pengguna" value="<?= $tempna->id_pengguna ?>" size="20" /> 
	<input type="hidden" name="id_demografi" id="id_demografi" value="<?= $hasil->id_demografi ?>" size="20" />
<!-- 
			<div class="form-group"> 
		<div class="image-editor">	
			<label class="col-md-12 control-label" for="userfile">Banner Demografi</label>
...
<div class="form-group"> 
	<label class="col-md-12 control-label" for="isi_demografi">Demografi Desa</label>
	 <div class="col-md-12">
	 <textarea class="form-control input-md" id="xxx"  name="isi_demografi"  cols="80"> <?= $hasil->isi_demografi ?> </textarea>
...
<input type="button" class="btn btn-danger" value="Batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_demografi'"/>
</span>	
</div>
