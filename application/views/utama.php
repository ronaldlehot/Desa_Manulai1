...
<body>
    <div id="wrapper">
		...
		<!-- Navigation -->
		<nav class="navbar  bg-warning navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="col-md-8">
			<div class="navbar-header">
					...
					if($role == 'Administrator') 
						...
						<img src="<?php echo base_url(); ?>assetku/img/76logo kab kupang-01.png" style="float:left; height:fixed; width:30%; margin-top:2px; margin-bottom:2px;"> 
					</a>
					</div>
