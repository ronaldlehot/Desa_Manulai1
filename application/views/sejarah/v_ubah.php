...
<?php echo form_open_multipart('admin/c_sejarah/update_sejarah'); ?>


	<input type="hidden" name="id_pengguna" id="id_pengguna" value="<?= $tempna->id_pengguna ?>" size="20" /> 
	<input type="hidden" name="id_sejarah" id="id_sejarah" value="<?= $hasil->id_sejarah ?>" size="20" />
	
	<!-- <div class="form-group"> 
		<div class="image-editor">	
			<label class="col-md-12 control-label" for="userfile">Banner Sejarah</label>
	...
	<div class="form-group"> 
		<label class="col-md-12 control-label" for="isi_sejarah">Sejarah Desa</label>
		 <div class="col-md-12">
		 <textarea class="form-control input-md" id="xxx"  name="isi_sejarah"  cols="80"> <?= $hasil->isi_sejarah ?> </textarea>
...
<input type="button" class="btn btn-danger" value="Batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_sejarah'"/>
</span>	
</div>
