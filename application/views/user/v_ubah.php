...
<legend></legend>
    ...
    <div class="form-group">
         ...
         <input class="form-control input-md" type="text" name="nik" id="nik" size="30" value="<?= $hasil->nik ?>"  /> 
    ...
    <div class="form-group">
         ...
         <div class="col-md-9"> 
         <span class="help-block">
         <input class="form-control input-md" type="text" name="nama" id="nama" size="30" value="<?= $hasil->nama ?>" disabled /> 
