...
<legend></legend>
	...
	<legend></legend>
   	...
   	<div class="form-group">
        ...
        <span class="help-block">
         <input class="form-control input-md" type="text" name="nik_sementara" id="nik_sementara" size="25" placeholder="NIK" /> 
	...
	<div class="form-group">
        ...
        <div class="col-md-9">
        <span class="help-block">
		 <input class="form-control input-md" type="text" name="nama_sementara" id="nama_sementara" size="25" placeholder="Nama Penduduk" /> 
