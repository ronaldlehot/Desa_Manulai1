...
<body style="background-image:url(<?php echo base_url(); ?>assetku/img/kantordesa1.jpeg);background-size:cover;">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel ">
                    ...
                    <div class="panel-heading">
						<img src="<?php echo base_url(); ?>assetku/img/Picsart_23-11-10_16-56-14-030.jpg" class="img-responsive"> 						
                    </div>
                    ...
                    <div class="panel-body">
						...
						<div class="col-md-14">
								<input type="submit" value="Kembali" class="btn btn-lg btn-danger btn-block" onclick="location.href='<?= base_url(); ?>web/c_home'"/>
						</div>
						<legend></legend>
                        <?php echo form_close(); ?>
                    </div>
